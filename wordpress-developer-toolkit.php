...
class WP_Developer_Toolkit {
  ...
  //TODO: prefix all function/variables names with class identifier
  ...
  /**
	  ...
	  *
	  * @since 0.1.0
	  * @uses WP_Developer_Toolkit::load_dependencies() Loads required filed
	  * @uses WP_Developer_Toolkit::add_hooks() Adds actions to hooks and filters
	  * @return void
	  */
